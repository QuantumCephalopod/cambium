...
def main():
    ...
    check('papers-physiology-witness' in papers_sierpinski and 'physiologyPhases=physiologyWitness.querySelector' in papers_sierpinski and 'physiologyWitness.dataset.visible' in papers_sierpinski,'Papers physiology explanation returned to the central demo')
    check('.papers-physiology-witness' in papers_sierpinski_css and 'papers-physiology-canvas{width:100%;height:100%;display:block;opacity:.68}' in papers_sierpinski_css,'Papers peripheral physiology witness / dimmed central demo CSS missing')
