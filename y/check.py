...
def main():
    ...
    check('papers-physiology-witness' in papers_sierpinski and 'physiologyPhases=physiologyWitness.querySelector' in papers_sierpinski and 'witness.dataset.visible' in papers_sierpinski,'Papers physiology explanation returned to the central demo')
